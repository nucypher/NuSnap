...
export async function configure(
  ...
  return await sendSnapMethod(
    { method: "nu_configure", params: { configuration } },
    this.snapId
  );
}
...
export async function signMessage(
  ...
  return await sendSnapMethod(
    { method: "nu_signMessage", params: { message } },
    this.snapId
  );
}
...
export async function signMessageRaw(
  ...
  return await sendSnapMethod(
    { method: "nu_signMessageRaw", params: { message: rawMessage } },
    this.snapId
  );
}
...
export async function sendMessage(
  ...
  return await sendSnapMethod(
    { method: "nu_sendMessage", params: { signedMessage } },
    this.snapId
  );
}
...
export async function getKeyPair(
  ...
  return await sendSnapMethod(
    { method: "nu_getKeyPair", params: { accountIndex } },
    this.snapId
  );
}
...
export async function calculateGasForMessage(
  ...
  return await sendSnapMethod(
    { method: "nu_getGasForMessage", params: { message } },
    this.snapId
  );
}
